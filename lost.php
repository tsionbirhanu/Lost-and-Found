...
// Fetch lost items reported by the user with JOIN to items table
$user_id = $_SESSION['user_id'];
$lost_items = [];
$stmt = $conn->prepare("
    SELECT i.id, i.title as item_name, i.description, i.location, 
           i.date_lost_found as lost_date, i.status, i.image_path as image
    FROM items i
    JOIN reports r ON i.id = r.item_id
    WHERE r.user_id = ? AND i.category = 'Lost'
...
<body>
    ...
    <header>
        <nav class="navbar">
            ...
            <div class="nav-links" id="navLinks">
                ...
                <a href="lost.php" class="active">LOST</a>
    ...
    <main>
        <div class="container">
            <h1 class="page-title">My Lost Items</h1>
            
            <div class="action-buttons" style="text-align: center; margin-bottom: 30px;">
                <a href="report-lost.php" class="btn btn-primary">
                    ...
                    <?php foreach($lost_items as $item): ?>
                        <div class="item-card">
                            ...
                            <div class="item-details">
                                ...
                                <p><strong>Date Lost:</strong> <?php echo date('M j, Y', strtotime($item['lost_date'])); ?></p>
